...
The Saqrmisc package includes six main functional areas:
...
5. **Categorical Variable Analysis** (`mosaic_analysis`)
6. **Network Estimation** (`estimate_single_network`)
...
- **Bayesian analysis**: Optional Bayes Factor computation
- **Type shortcuts**: `type = "np"` for nonparametric, `type = "kw"` for Kruskal-Wallis
...
## 3. Categorical Frequency Tables
